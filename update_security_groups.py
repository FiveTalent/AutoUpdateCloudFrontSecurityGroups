...
SECURITY_GROUP_TAG_FOR_GLOBAL_HTTP = {
    'Name': 'cloudfront_g', 'AutoUpdate': 'true', 'Protocol': 'http'}
SECURITY_GROUP_TAG_FOR_GLOBAL_HTTPS = {
    'Name': 'cloudfront_g', 'AutoUpdate': 'true', 'Protocol': 'https'}
SECURITY_GROUP_TAG_FOR_REGION_HTTP = {
    'Name': 'cloudfront_r', 'AutoUpdate': 'true', 'Protocol': 'http'}
...
def update_security_groups(new_ranges):
    ...
    global_https_group = get_security_groups_for_update(
        client, SECURITY_GROUP_TAG_FOR_GLOBAL_HTTPS)
    ...
    print('Found ' + str(len(global_http_group)) +
          ' CloudFront_g HttpSecurityGroups to update')
    print('Found ' + str(len(global_https_group)) +
          ' CloudFront_g HttpsSecurityGroups to update')
    print('Found ' + str(len(region_http_group)) +
          ' CloudFront_r HttpSecurityGroups to update')
    print('Found ' + str(len(region_https_group)) +
          ' CloudFront_r HttpsSecurityGroups to update')
    ...
    result.append('Updated ' + str(global_http_updated) + ' of ' +
                  str(len(global_http_group)) + ' CloudFront_g HttpSecurityGroups')
    result.append('Updated ' + str(global_https_updated) + ' of ' +
                  str(len(global_https_group)) + ' CloudFront_g HttpsSecurityGroups')
    result.append('Updated ' + str(region_http_updated) + ' of ' +
                  str(len(region_http_group)) + ' CloudFront_r HttpSecurityGroups')
    result.append('Updated ' + str(region_https_updated) + ' of ' +
                  str(len(region_https_group)) + ' CloudFront_r HttpsSecurityGroups')
